...
<div class="navbar navbar-inverse set-radius-zero" >
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="dashboard.php" class=" hover-line">DASHBOARD</a></li>
                           
                            <li>
                                <a href="#" class="dropdown-toggle hover-line" id="ddlmenuItem" data-toggle="dropdown"> Categories <i class="fa fa-angle-down"></i></a>
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle hover-line" id="ddlmenuItem" data-toggle="dropdown"> Authors <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
 ...
 <li>
                                <a href="#" class="dropdown-toggle hover-line" id="ddlmenuItem" data-toggle="dropdown"> Books <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                           ...
                           <li>
                                <a href="#" class="dropdown-toggle hover-line" id="ddlmenuItem" data-toggle="dropdown"> Issue Books <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                             ...
                             <li><a href="reg-students.php" class="hover-line">Reg Students</a></li>
                    
  <li><a href="change-password.php" class="hover-line">Change Password</a></li>
                        </ul>
                    </div>
                </div>
